            ...
            <div className="hero bg-[#EEF9FF]  md:h-[900px]">
                <div className="hero-content flex-col md:flex-row-reverse  gap-0 ">
                    <div className="text-center lg:text-left">
                        <img className='md:h-[580px]  md:w-[600px]  object-cover' src={register} alt="" />
                    </div>
                    <div className="card bg-base-100 md:w-[400px] md:h-[580px] rounded-none  shrink-0 ">
                        <form onSubmit={handleSubmit} className="card-body justify-center items-center ">
                        ...
                        <p className='text-center '>All ready Have An Account ? <NavLink to='/auth/login'><span className='text-[#f44848]'>Login</span></NavLink></p>
                    </div>
                </div>
            </div>
        </div>
