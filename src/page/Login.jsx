    ...
    const handleSubmit = (e) => {
        ...
        userLogin(email, password)
            ...
            .catch((err) => {
                ...
                setError({ ...error, login: err.code || err.message })
            });
            ...
            <div className="hero bg-[#EEF9FF]  md:h-[800px]">
                <div className="hero-content flex-col md:flex-row-reverse gap-0 ">
                    <div className="text-center lg:text-left">
                        <img className='md:h-[480px]' src={login} alt="" />
                    </div>
                    <div className="card bg-base-100 md:w-[400px] md:h-[480px] rounded-none  shrink-0 ">
                        <form onSubmit={handleSubmit} className="card-body justify-center items-center space-y-2">
                            ...
                            <div className="form-control grid relative">
                                ...
                                {
                                    error.login && (
                                        <label className="label text-sm text-red-600 py-2">
                                            {error.login}
                                        </label>
                                    )
                                }
                        ...
                        <p className='text-center '>Don't Have An Account ? <NavLink to='/auth/register'><span className='text-[#f44848]'>Register</span></NavLink></p>
                    </div>
                </div>
            </div>
        </div>
